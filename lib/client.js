...
var __boardUiBundle = (() => {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", { className: "bb-drawer", style: { width: drawerContentW }, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "bb-drawer-inner", children: [
                ...
                conversationTabs.rootId !== void 0 && conversationTabs.entries.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "bb-conversation-tabs", role: "tablist", "aria-label": t("drawer.conversationTabs"), children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "button",
                    {
                      type: "button",
    ...
    if (failed > 0 || mainError !== null) {
      lines.push(
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bb-card-hint", "data-kind": "failed", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "bb-card-hint-msg", children: failed > 0 ? t("card.failedHint", { n: failed }) : t("card.mainErrorHint", { message: mainError.message }) }),
      ...
      if (item.status === "running" || item.status === "paused") {
        ...
        items.push(
          { label: t("task.restart"), run: () => {
            setMenu(MENU_NONE);
            retrySession(id).catch((err) => console.warn("board-ui: retry failed:", err));
          } },
  ...
  function ActivityPanel({ sessionId, useSessions, t, switchToChat, mainErrorOf }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bb-act", children: [
      mainError !== null && mainError !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bb-act-error", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "bb-act-error-msg", children: mainError.message }),
  ...
  // src/client/index.tsx
  var BUILD_TAG = true ? "202608200356" : "dev";
